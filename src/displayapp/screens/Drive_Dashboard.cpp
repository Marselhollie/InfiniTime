...
static const char* const dashText =
  "DASHBOARD\n"
  "\n"
  "ARTIST RESIDENCY- is a branch to land at. I know it's not gonna be a bunch of hot girls, but I think it could be a place of a lot of fun and genuine friendships and social Ive wanted to commit myself to. .\n"
  "\n"
  " I deeply believe I can earn a living and stay happier in simple ways. Book of enoch, emerald  tablets, sumerian or pre-bible books,atomic habit, mussolini; A LIFE OF LISTENING


i like reading biographies about strategic events they moved through, the power of positive thinking Norman Peele. Ego is the enemy Ryan Holiday
 .\n"
  "\n"
